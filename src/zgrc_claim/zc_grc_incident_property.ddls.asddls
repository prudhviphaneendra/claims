...
@EndUserText.label: 'Incident Only Property'
@AccessControl.authorizationCheck: #CHECK

//@ObjectModel.query.implementedBy: 'ABAP:ZCL_GRC_VE_CONTROL_FIELDS'

define root view entity ZC_GRC_INCIDENT_PROPERTY
...
Lastchangedby,
Lastchangedat,
_claim_trn : redirected to composition child ZC_GRC_INCIDENTTXN_PROPERTY,
_Matrix
}
where ClaimRecType = '500043';
