...
//  composition [*] of ZR_GRC_CLAIM_MATRIX as _Matrix
  association[0..1] to ZR_GRC_CLAIM_LOCATION as _Location
  on $projection.InsuredName = _Location.Insured_Name
  association[0..*] to ZR_GRC_CLAIM_MATRIX as _Matrix
  on $projection.ClaimUuid = _Matrix.ClaimUuid
  ...
  association [0..1] to ZR_WORK_RELATED_PL           as _WorkRelated_PL         on $projection.WorkRelatedDel = _WorkRelated_PL.Id
   ...
   association [0..1] to ZR_COVERAGEMAJOR_PL           as _CoverageMajor_PL         on $projection.CoverageMajor = _CoverageMajor_PL.Id
   association [0..1] to ZR_COVERAGEMINOR_PL           as _CoverageMinor_PL         on $projection.CoverageMinor = _CoverageMinor_PL.Id
  ...
  // $projection.ClaimRecType = _Picklst.ValueId
{
  key claim_uuid                     as ClaimUuid,
      ...
      gross_incurred                 as GrossIncurred,
      ...
      lastchangedat                  as Lastchangedat,
       location_uuid as Location_UUID,
      _claim_trn,
      _Location,
      _Matrix,
      //  _Picklst
