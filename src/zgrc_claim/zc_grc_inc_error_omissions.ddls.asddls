...
@EndUserText.label: 'Incident Only Errors & Omissions'
@AccessControl.authorizationCheck: #CHECK
//@ObjectModel.query.implementedBy: 'ABAP:ZCL_GRC_VE_CONTROL_FIELDS'
define root view entity ZC_GRC_INC_ERROR_OMISSIONS
...
Lastchangedby,
Lastchangedat,
_claim_trn : redirected to composition child ZC_GRC_INCTXN_ERROR_OMISSIONS,
_Matrix
}
where ClaimRecType = '500036';
