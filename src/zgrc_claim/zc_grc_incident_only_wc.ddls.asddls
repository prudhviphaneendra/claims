...
@EndUserText.label: 'Incident Only WC'
@AccessControl.authorizationCheck: #CHECK
//@ObjectModel.query.implementedBy: 'ABAP:ZCL_GRC_VE_CONTROL_FIELDS'
define root view entity ZC_GRC_INCIDENT_ONLY_WC
...
Lastchangedby,
Lastchangedat,
_claim_trn : redirected to composition child ZC_GRC_INCIDENTTXN_ONLY_WC,
_Matrix
}
where ClaimRecType = '500044';
