CLASS zcl_grc_domain_fix_values DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GRC_DOMAIN_FIX_VALUES IMPLEMENTATION.


  METHOD if_rap_query_provider~select.

   DATA business_data TYPE TABLE OF zi_grc_domain_fix_val .
    DATA business_data_line TYPE zi_grc_domain_fix_val .
