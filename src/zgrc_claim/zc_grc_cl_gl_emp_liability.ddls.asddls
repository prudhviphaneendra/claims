...
@EndUserText.label: 'Claims GL Employers Liability'
@AccessControl.authorizationCheck: #CHECK
//@ObjectModel.query.implementedBy: 'ABAP:ZCL_GRC_VE_CONTROL_FIELDS'
define root view entity ZC_GRC_CL_GL_EMP_LIABILITY
...
Lastchangedby,
Lastchangedat,
_claim_trn : redirected to composition child ZC_GRC_CLTXN_GL_EMP_LIABILITY,
_Matrix
}
where ClaimRecType = '500024';
