...
@EndUserText.label: 'Incident Only GL'
@AccessControl.authorizationCheck: #CHECK
//@ObjectModel.query.implementedBy: 'ABAP:ZCL_GRC_VE_CONTROL_FIELDS'
define root view entity ZC_GRC_INCIDENT_ONLY_GL
...
Lastchangedby,
Lastchangedat,
_claim_trn : redirected to composition child ZC_GRC_INCIDENTTXN_ONLY_GL,
_Matrix
}
where ClaimRecType = '500038';
