...
define root view entity ZC_GRC_CLAIM_INCIDENT_ONLY_CCC
...
Lastchangedby,
Lastchangedat,  
_claim_trn : redirected to composition child ZC_GRC_CLAIMTXN_INC_ONLY_CCC,
_Matrix
}
where ClaimRecType = '500035';
