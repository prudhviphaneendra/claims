...
@EndUserText.label: 'Incident Only Captive CCC'
@AccessControl.authorizationCheck: #CHECK
//@ObjectModel.query.implementedBy: 'ABAP:ZCL_GRC_VE_CONTROL_FIELDS'
define root view entity ZC_GRC_INC_CAPTIVE_CCC
...
Lastchangedby,
Lastchangedat,
_claim_trn : redirected to composition child ZC_GRC_INCTXN_CAPTIVE_CCC,
_Matrix
}
where ClaimRecType = '500034';
