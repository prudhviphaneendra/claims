...
@EndUserText.label: 'Claims GL'
@AccessControl.authorizationCheck: #CHECK


define root view entity ZC_GRC_CLAIMS_GL
...
WhoOwnsProperty,
  _claim_trn : redirected to composition child ZC_GRC_CLAIMTXN_GL,
   _Matrix
}
where ClaimRecType = '500023';
