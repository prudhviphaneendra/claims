...
@EndUserText.label: 'Maersk Workers Compensation'
@AccessControl.authorizationCheck: #CHECK
//@ObjectModel.query.implementedBy: 'ABAP:ZCL_GRC_VE_CONTROL_FIELDS'
define root view entity ZC_GRC_WORKERS_COMPENSATION
...
Lastchangedby,
Lastchangedat,
_claim_trn : redirected to composition child ZC_GRC_WORKERSTXN_COMPENSATION,
_Matrix
}
where ClaimRecType = '500045';
