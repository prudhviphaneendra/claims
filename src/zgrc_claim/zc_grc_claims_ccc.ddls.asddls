...
_SubType_PL.Sub_Type as SubType_PL,
      ...
      VesselOwnerName,
      Voyage,
      _claim_trn : redirected to composition child ZC_TGRC_CLAIMTXN_CCC,
      _Matrix
}
where ClaimRecType = '500020';
