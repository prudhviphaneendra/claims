...
@EndUserText.label: 'Claims Errors & Omissions'
@AccessControl.authorizationCheck: #CHECK
//@ObjectModel.query.implementedBy: 'ABAP:ZCL_GRC_VE_CONTROL_FIELDS'
define root view entity ZC_GRC_CLAIMS_ERRORS_OMISSIONS
...
Lastchangedby,
Lastchangedat,
_claim_trn : redirected to composition child ZC_GRC_CLTXN_ERRORS_OMISSIONS,
_Matrix

}
where ClaimRecType = '500021';
