...
@EndUserText.label: 'Projection View for GRM Property - Txn'
@Metadata.allowExtensions: true
define view entity ZC_GRC_CLAIMTXN_GRM_LIABILITY  as projection on ZR_TGRC_CLAIM_TRN
{
  ...
  key ClaimTrnUuid,
      ...
      Lastchangedby,
      Lastchangedat,
      _Claim : redirected to parent ZC_GRC_GRM_LIABILITY,
